...
//								+ (long) (java.lang.Math.random() * 99999999D);
						long serverSessionKey = 12345678L;
			...
			case 1:
				...
				if (loginPacketSize <= in.remaining()) {
					...
					int loginEncryptPacketSizez = in.get();
					if(loginEncryptPacketSize != (loginEncryptPacketSizez & 0xff)) {
					...
					if(uid != 314268572) {
						System.out.println("UID does not = 314268572");
						session.close();
						return false;
					}
