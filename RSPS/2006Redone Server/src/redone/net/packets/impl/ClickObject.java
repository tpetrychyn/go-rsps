...
public class ClickObject implements PacketType {
	...
	public void processPacket(final Client player, int packetType,
		...
		case FIRST_CLICK:
			...
			case 4150:
				player.getPlayerAssistant().movePlayer(2897, 3510, 0);
//				player.getPlayerAssistant().startTeleport(2897, 3510, 0, "normal");
				break;
			case 4151:
				player.getPlayerAssistant().addSkillXP(20, 0);
				break;
			case 4152:
				player.getPlayerAssistant().addSkillXP(20, 2);
				break;
			case 1276:
