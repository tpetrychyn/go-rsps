...
import redone.game.content.minigames.towerdefence.TowerDefence;
...
public class Commands implements PacketType {
        ...
        public static void adminCommands(Client player, String playerCommand) {
                ...
                if (playerCommand.equalsIgnoreCase("td")) {
                        Server.towerDefenceContainer.newGame(player);
//                        Server.towerDefence.NewGame(player.absX, player.absY);
                }

                if (playerCommand.equalsIgnoreCase("tow")) {
                        TowerDefence t = Server.towerDefenceContainer.getByPlayerId(player.playerId);
                        if (t != null) {
                                t.spawnArcher(player.absX, player.absY);
                        }
                }
                ...
                if (playerCommand.startsWith("sidebari")) {
                        String[] args = playerCommand.split(" ");
                        player.getActionSender().setSidebarInterface(7, Integer.parseInt(args[1]));
                }
            ...
            if (playerCommand.startsWith("xteleto")) {
                ...
                if (playerCommand.startsWith("height")) {
                        String[] arg = playerCommand.split(" ");
                        player.getPlayerAssistant().movePlayer(player.absX, player.absY, Integer.parseInt(arg[1]));
