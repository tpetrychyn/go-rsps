...
public class Connection {
	...
	public static void unMuteUser(String name) {
		...
		deleteFromFile("C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/UsersMuted.txt", name);
	}

	public static void unIPMuteUser(String name) {
		mutedIps.remove(name);
		deleteFromFile("C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/IpsMuted.txt", name);
	}
	...
	public static void removeNameFromBanList(String name) {
		...
		deleteFromFile("C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/UsersBanned.txt", name);
	}
	...
	public static void banUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/UsersBanned.txt"));
			String data = null;
			try {
	...
	public static void muteUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/UsersMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedNames.add(data);
	...
	public static void banIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/IpsBanned.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					addIpToBanList(data);
	...
	public static void muteIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/IpsMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedIps.add(data);
	...
	public static void addNameToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/UsersBanned.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addUserToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/UsersMuted.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addIpToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/IpsBanned.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addIpToMuteFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter(
					"C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/bans/IpsMuted.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
