...
public class Climbing {
	...
	public static void processClimbing(Client client) {
		...
		case 1755:
			if (client.objectX == 3116 && client.objectY == 9852) {
				...
				// OtherObjects.useUp(client, client.id);
	...
	public static void climbUp(Client client) {
		...
		default:
			...
			System.out.println("Bug detected with climbing up object " + client.objectId + " x " + client.objectX + " y " + client.objectY + ".");
			break;
		}
	}
	...
	public static void climbDown(Client client) {
		...
		default:
			...
			client.getActionSender().sendMessage("This object is currently not supported.");
			System.out.println("Bug detected with climbing down object " + client.objectId + " x " + client.objectX + " y " + client.objectY + ".");
			break;
		}
	}
