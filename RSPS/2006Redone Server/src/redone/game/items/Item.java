...
public class Item {
	...
	static {
		...
		try {
			FileInputStream dataIn = new FileInputStream(new File("C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/data/stackable.dat"));
		...
		try {
			FileInputStream dataIn = new FileInputStream(new File("C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/data/notes.dat"));
			while ((c = dataIn.read()) != -1) {
				if (c == 0) {
		...
		counter = 0;
		try {
			FileInputStream dataIn = new FileInputStream(new File("C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/data/equipment.dat"));
			while ((c = dataIn.read()) != -1) {
		 ...
		 * FileReader("C:\\Users\\Taylor\\Desktop\\RSPS\\2006Redone Server\\data/data/equipment.dat")); String name = null; while
