...
//				players[i].updateWalkEntities();

//				players[i].getPlayerAssistant().sendMapState(0);
//				players[i].getPlayerAssistant().walkableInterface(-1);
//				players[i].getActionSender().showOption(3, 0, "Null", 1);
...
//		plr.forcedChatUpdateRequired = true;
